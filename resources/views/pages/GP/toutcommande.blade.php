...
<body>
    ...
    <div class="options-container">
        <div class="options"><a href="{{route('attentecommande')}}" onclick="selectOption(event)">tout</a></div>
        <div class="option"><a href="{{route('attentecommande')}}" onclick="selectOption(event)">en attente</a></div>
        <div class="option"><a href="{{route('livrercommande')}}" onclick="selectOption(event)">livrer</a></div>
        <div class="option"><a href="{{route('annulercommande')}}" onclick="selectOption(event)">annuler</a></div>
    </div>
    
    @include('components.gp.table_commande',["commandes"=> $commandes])
