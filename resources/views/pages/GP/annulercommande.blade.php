...
<body>
    ...
    <div class="options-container">
        <div class="option"><a href="{{route('toutcommande')}}" onclick="selectOption(event)">tout</a></div>
        ...
        <div class="options"><a href="{{route('annulercommande')}}" onclick="selectOption(event)">annuler</a></div>
    </div>
