...
<body>
    ...
    <div class="options-container">
        ...
        <div class="options"><a href="{{route('attentecommandeUser')}}" onclick="selectOption(event)">en attente</a></div>
        <div class="option"><a href="{{route('livrercommandeUser')}}" onclick="selectOption(event)">livrer</a></div>
        <div class="option"><a href="{{route('annulercommande')}}" onclick="selectOption(event)">annuler</a></div>
    </div>
